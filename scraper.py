...
def get_models(brand, model):
    try:
        ...
        url = f"/sch/ajax/refine?no_encode_refine_params=1&_fsrp=1&rt=nc&_from=R40&_nkw={brand}+{model}&_sacat=0&&_oaa=1&LH_Sold=1&_aspectname=aspect-Model&modules=SEARCH_REFINEMENTS_MODEL_V2%3Afa"
